...
/**
 * PANTALLA FINAL DE DERROTA DEL NIVEL FINAL
...
public class PantallaFinalPerdida implements Pantalla {
    ...
    public void pulsarRaton(MouseEvent e) {
        if (SwingUtilities.isLeftMouseButton(e)){
            ...
            //PASAMOS A LA PANTALLA DE NIVEL 1
            PantallaNivelFinal pantallaNivel1 = new PantallaNivelFinal(p);
            pantallaNivel1.inicializarPantalla();
            p.cambiarPantalla(pantallaNivel1);
        }
        else{ //SI DAMOS CLIC DERECHO, SALDREMOS DEL JUEGO
            System.exit(0);
        }
    }
