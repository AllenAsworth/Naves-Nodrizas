package pantallas.niveles.nivel3;
...
import pantallas.niveles.nivelFinal.PantallaNivelFinal;
...
public class PantallaFinalGanada implements Pantalla {
    ...
    public void pintarPantalla(Graphics g) {
        ...
        g.setColor(colorLetra);
        g.setFont(fuenteGanada);
        g.drawString("Haga clic para ir al jefe", 0, 300);
    }
    ...
    public void pulsarRaton(MouseEvent e) {
        PantallaNivelFinal pantallaNivelFinal = new PantallaNivelFinal(p);
        pantallaNivelFinal.inicializarPantalla();
        p.cambiarPantalla(pantallaNivelFinal);
    }
