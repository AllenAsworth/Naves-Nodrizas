...
import java.io.*;
import pantallas.niveles.nivel2.*;

/**
 * PANTALLA FINAL DE VICTORIA DEL NIVEL 1
...
public class PantallaFinalGanada implements Pantalla {
    ...
    public void pintarPantalla(Graphics g) {
        ...
        g.setColor(colorLetra);
        g.setFont(fuenteGanada);
        g.drawString("Haga clic para el segundo nivel", 0, 300);
    }
    ...
    public void pulsarRaton(MouseEvent e) {
        ...
        //INICIALIZAMOS LA PANTALLA DE NIVEL 2
        PantallaNivel2 pantallaNivel2 = new PantallaNivel2(p);
        pantallaNivel2.inicializarPantalla();
        p.cambiarPantalla(pantallaNivel2);
    }
